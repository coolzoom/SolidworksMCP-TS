...
def build_screw_fasteners(size: str, length_mm: float, *, real_thread: bool = True):
...
def main() -> int:
    ...
    if thread_mode == "real" and not _fasteners_available():
        App.Console.PrintWarning(
            "Fasteners Workbench not found. Run freecad-ai-bench/install-fasteners.bat "
    ...
    if use_fasteners:
        ...
        doc, body = build_screw_simple(size, length, cosmetic_thread=thread_mode == "simple")
